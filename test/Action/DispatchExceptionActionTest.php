...
/**
 * @coversDefaultClass \Spiffy\Framework\Action\DispatchExceptionAction
 */
class DispatchExceptionActionTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testInvoke()
    {
        ...
        $action = new DispatchExceptionAction(new ViewManager(new VardumpStrategy()));
        $result = $action($ex);
